...
export default function NavigationLinks({ navigationLinksArr }) {
  ...
  // JSX
  return (
    <ul className="flex flex-row items-center justify-center gap-[10px] smallTab:w-[100%] smallTab:flex-col smallTab:gap-[0px]">
      {navigationLinksArr.map((val, i) => (
        <li key={i} className="smallTab:w-[100%]">
          ...
          >
            <span className="text-[20px] smallTab:text-base">{val.icon}</span>
